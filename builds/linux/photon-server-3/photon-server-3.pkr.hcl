...
# Packer template for VMware Photon OS 3.0.
...
variable "iso_file" {
  type    = string
  description = "The file name of the ISO image. (e.g. 'iso-photon-server-3.iso')"
  default = ""
}

variable "iso_checksum" {
  type    = string
  description = "The SHA-512 checkcum of the ISO image. (e.g. Result of 'shasum -a 512 iso-photon-server-3.iso')"
  default = ""
}
