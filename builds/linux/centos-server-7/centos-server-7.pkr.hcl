...
variable "iso_file" {
  type    = string
  description = "The file name of the ISO image. (e.g. 'iso-centos-server-7.iso')"
  default = ""
}

variable "iso_checksum" {
  type    = string
  description = "The SHA-512 checkcum of the ISO image. (e.g. Result of 'shasum -a 512 iso-centos-server-7.iso')"
  default = ""
}
...
variable "vm_guest_os_type" {
  type    = string
  description = "The guest operating system type, also know as guestid. (e.g. 'centos7_64Guest')"
  default = ""
}
