...
variable "iso_file" {
  type    = string
  description = "The file name of the ISO image. (e.g. 'iso-ubuntu-server-18-04-lts.iso')"
  default = ""
}

variable "iso_checksum" {
  type    = string
  description = "The SHA-512 checkcum of the ISO image. (e.g. Result of 'shasum -a 512 iso-ubuntu-server-18-04-lts.iso')"
  default = ""
}
...
variable "vm_guest_os_version" {
  type    = string
  description = "The guest operatiing system version. Used for naming. (e.g. '18-04-lts')"
  default = ""
}
